...
CREATE TABLE IF NOT EXISTS `{target_table}` (
    ...
    home_n_last_win INT64,
    away_n_last_win INT64,
    home_n_last_match INT64,
    away_n_last_match INT64,
...
THEN UPDATE SET
    ...
    target.home_n_last_win = source.home_n_last_win,
    target.away_n_last_win = source.away_n_last_win,
    target.home_n_last_match = source.home_n_last_match,
    target.away_n_last_match = source.away_n_last_match,
...
VALUES (
    ...
    source.home_n_last_win,
    source.away_n_last_win,
    source.home_n_last_match,
    source.away_n_last_match,
